...
public class AnswerMainActivity7 extends AppCompatActivity {
    @BindView(R.id.study)
    TextView study;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initWindow();
        //播放音乐
        mediaPlayer = MediaPlayer.create(AnswerMainActivity7.this, R.raw.mp13);
        mediaPlayer.start();
        //循环播放
    ...
    private void initWindow() {
        ...
        //飞花粒子效果https://blog.csdn.net/mymolit/article/details/79578693
        new ParticleSystem(this, 1000, R.drawable.confeti3, 10000)
                .setSpeedModuleAndAngleRange(0.05f, 0.2f, 0, 90)
                .setRotationSpeed(60)
                .setAcceleration(0.00005f, 110)
                .emit(200, -900, 20, 600000);

        new ParticleSystem(this, 1000, R.drawable.confeti2, 10000)
                .setSpeedModuleAndAngleRange(0.05f, 0.2f, 0, 90)
                .setRotationSpeed(60)
                .setAcceleration(0.00005f, 110)
                .emit(200, -900, 20, 600000);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn:
                ...
                startActivity(new Intent(AnswerMainActivity7.this, AnswerMainActivity.class));
                break;
        }
    }
