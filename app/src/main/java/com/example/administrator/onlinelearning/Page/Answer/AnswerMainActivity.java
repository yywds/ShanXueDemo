...
//            getWindow().setNavigationBarColor(Color.parseColor("#6200ED"));
        ...
        MessageDialog.show(AnswerMainActivity.this, "提示", "请在15秒内抢答！", "开始答题", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void dati1() {
        timu.setText("1.以下四个选项中哪个具有“滑稽的”的意思?");
        xuanze1.setText("A.real");
        xuanze2.setText("B.painting");
        xuanze3.setText("C.funny");
        xuanze4.setText("D.live");
    }

    public void tiaozhan() {
        mediaPlayer = MediaPlayer.create(AnswerMainActivity.this, R.raw.yizhaodi);
        mediaPlayer.start();
        //10秒，每秒一次的跳转
    ...
    public void shijiandao() {
        SelectDialog.show(AnswerMainActivity.this, "时间到", "抢答失败！", "再挑战一次", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                tiaozhan();
            }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(AnswerMainActivity.this, AnswerMainActivityshibai.class));
            }
        });
    }
    ...
    //选择错误的对话框
    public void shibai() {
        MessageDialog.show(AnswerMainActivity.this, "很遗憾", "回答错误！", "继续抢答", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    public void zhengque() {
        MessageDialog.show(AnswerMainActivity.this, "恭喜你", "回答正确！", "下一题", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mediaPlayer.stop(); //答题音乐停止
                startActivity(new Intent(AnswerMainActivity.this, AnswerMainActivity2.class));
            }
        });
    }
...
//        MessageDialog.show(AnswerMainActivity.this, "提示", "请先作答！", "好的", new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
//            }
//        });    }
