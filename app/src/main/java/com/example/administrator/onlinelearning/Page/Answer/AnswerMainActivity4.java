...
public class AnswerMainActivity4 extends AppCompatActivity {
    @BindView(R.id.study)
    TextView study;
...
//            getWindow().setNavigationBarColor(Color.parseColor("#6200ED"));
    ...
    private void dati1() {
        timu.setText("4.以下四个选项中哪个具有“油画”的意思?");
        xuanze1.setText("A.funny");
        xuanze2.setText("B.painting");
        xuanze3.setText("C.live");
        xuanze4.setText("D.real");
    }

    public void tiaozhan() {
        mediaPlayer = MediaPlayer.create(AnswerMainActivity4.this, R.raw.yizhaodi);
        mediaPlayer.start();
        //10秒，每秒一次的跳转
    ...
    public void shijiandao() {
        SelectDialog.show(AnswerMainActivity4.this, "时间到", "抢答失败！", "再挑战一次", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mediaPlayer.stop();
                startActivity(new Intent(AnswerMainActivity4.this, AnswerMainActivity.class));
            }
        }, "取消", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mediaPlayer.stop();
                startActivity(new Intent(AnswerMainActivity4.this, AnswerMainActivityshibai.class));
            }
        });
    }
    ...
    //选择错误的对话框
    public void shibai() {
        MessageDialog.show(AnswerMainActivity4.this, "很遗憾", "回答错误！", "继续抢答", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    public void zhengque() {
        MessageDialog.show(AnswerMainActivity4.this, "恭喜你", "回答正确！", "下一题", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mediaPlayer.stop();
                startActivity(new Intent(AnswerMainActivity4.this, AnswerMainActivity5.class));
            }
        });
    }
...
//        MessageDialog.show(AnswerMainActivity4.this, "提示", "请先作答！", "好的", new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
//            }
//        });    }
